...
namespace Simplex {
    ...
    /// </summary>
    public class Noise {
        public double[] Calc1D(int width, double scale) {
        ...
        public double[,] Calc2D(int width, int height, double scale) {
        ...
        public double[,,] Calc3D(int width, int height, int length, double scale) {
        ...
        public double CalcPixel1D(int x, double scale) {
            return Generate(x * scale) * 128 + 128;
        }

        public double CalcPixel2D(int x, int y, double scale) {
            return Generate(x * scale, y * scale) * 128 + 128;
        }

        public double CalcPixel3D(int x, int y, int z, double scale) {
        ...
        /// <param name="x"></param>
        /// <returns></returns>
        internal double Generate(double x) {
            int i0 = FastFloor(x);
            int i1 = i0 + 1;
            double x0 = x - i0;
            double x1 = x0 - 1.0f;
        ...
        /// <param name="y"></param>
        /// <returns></returns>
        internal double Generate(double x, double y) {
        ...
        internal double Generate(double x, double y, double z) {
